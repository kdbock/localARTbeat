      ...
      child: Column(
        ...
        children: const [
          ...
          _TermsSection(
            ...
            content:
                'a) Information You Provide:\n• Account Information: Name, email, password, ZIP/postal code.\n• Profile Information: Bio, profile photo, customization settings.\n• Sponsorship/Event Information: Business details, event details, contact information, creative notes, and review materials.\n• Payment Information: Processed by Apple, Google, Stripe, or supported providers; ARTbeat never stores full card details.\n• Content: Captures, events, sponsorships, comments, and reports you submit.\n\nb) Information We Collect Automatically:\n• Device Information: Device type, operating system, app version, crash reports.\n• Usage Data: Logins, navigation, feature usage, interactions (favorites, likes, shares).\n• Location Data: GPS data when you use Art Walks, map features, or location-tagged captures.\n• Analytics Data: Firebase Analytics, engagement tracking, sponsorship performance metrics.\n\nc) Information from Third Parties:\n• App Stores (Apple/Google): For app downloads, in-app purchases, refunds.\n• Social & Sharing Platforms: If you share content via external apps (e.g., Instagram, Facebook).\n• Payment Processors (Stripe): Payment confirmations, refunds, and chargeback details where Stripe is used.',
          ),

          _TermsSection(
            title: '3. How We Use Your Information',
            content:
                'We use data to:\n• Provide and improve ARTbeat features (profiles, captures, discovery, events, sponsorships, community activity).\n• Process payments, purchases, and refunds.\n• Enable GPS navigation and location-based discovery.\n• Send notifications (reminders, purchases, account alerts).\n• Moderate content, investigate reports, and enforce policies.\n• Provide aggregated sponsorship and event performance information.\n• Ensure safety, prevent fraud, and comply with legal requirements.',
          ),

          _TermsSection(
            title: '4. Sharing of Information',
            content:
                'We share your data only as needed:\n• With Service Providers: Apple/Google for in-app purchases, Stripe where used for ticketing or web payments, and Firebase for storage, authentication, and analytics.\n• With Other Users: Profile details, captures, approved events, approved sponsorships, or comments you choose to make public.\n• For Moderation/Legal Compliance: To investigate abuse reports, process copyright complaints, respond to law enforcement requests, or protect platform security.\n• In Business Transfers: If ARTbeat undergoes a merger, acquisition, or asset sale.\n\nWe do not sell your personal information.',
          ),
