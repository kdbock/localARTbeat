...
class _AdsRouteScreenState extends State<AdsRouteScreen> {
        ...
        child: Column(
          ...
          children: [
            ...
            const Wrap(
              ...
              runSpacing: 12,
              children: [
                _AdsFeatureChip(icon: Icons.public, label: 'Local discovery'),
                _AdsFeatureChip(icon: Icons.palette, label: 'Artist funding'),
                _AdsFeatureChip(
                  icon: Icons.repeat,
  ...
  Future<void> _openBrowseAdsFlow() async {
    await Navigator.of(context).push<void>(
      MaterialPageRoute<void>(builder: (context) => const LocalAdsListScreen()),
    );
  }
