...
class GoogleSignInAndroid extends GoogleSignInPlatform {
  ...
  @override
  Future<void> clearAuthorizationToken(ClearAuthorizationTokenParams params) => _hostApi.clearAuthorizationToken(params.accessToken);
  ...
  @override
  Future<void> signOut(SignOutParams params) => _hostApi.clearCredentialState();
