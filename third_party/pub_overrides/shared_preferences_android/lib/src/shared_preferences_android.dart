...
class SharedPreferencesAndroid extends SharedPreferencesStorePlatform {
  ...
  @override
  Future<bool> remove(String key) async => api.remove(key);
  ...
  @override
  Future<bool> clear() async => clearWithParameters(
      ClearParameters(filter: PreferencesFilter(prefix: _defaultPrefix)),
    );

  @override
  Future<bool> clearWithPrefix(String prefix) async => clearWithParameters(
  ...
  @override
  Future<Map<String, Object>> getAll() async => getAllWithParameters(
      GetAllParameters(filter: PreferencesFilter(prefix: _defaultPrefix)),
    );

  @override
  Future<Map<String, Object>> getAllWithPrefix(String prefix) async => getAllWithParameters(
