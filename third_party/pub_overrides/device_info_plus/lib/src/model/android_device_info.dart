...
class AndroidDeviceInfo extends BaseDeviceInfo {
  ...
  static AndroidDeviceInfo fromMap(Map<String, dynamic> map) => AndroidDeviceInfo._(
      data: map,
...
class AndroidBuildVersion {
  ...
  static AndroidBuildVersion _fromMap(Map<String, dynamic> map) => AndroidBuildVersion._(
      baseOS: map['baseOS'],
