...
import 'camerax_library.dart' show PigeonInstanceManager;
import 'camerax_library.g.dart' as camerax;
import 'camerax_library.g.dart' show PigeonInstanceManager;
...
class CameraInfo extends camerax.CameraInfo {
  ...
  /// create copies for an [camerax.PigeonInstanceManager].
  CameraInfo.detached({
  ...
  @override
  Future<LiveData<camerax.CameraState>> getCameraState() async => (await super.getCameraState()) as LiveData<camerax.CameraState>;

  @override
  Future<LiveData<camerax.ZoomState>> getZoomState() async => (await super.getZoomState()) as LiveData<camerax.ZoomState>;

  @override
  // ignore: non_constant_identifier_names
  CameraInfo pigeon_copy() => CameraInfo.detached(
      sensorRotationDegrees: sensorRotationDegrees,
      lensFacing: lensFacing,
      exposureState: exposureState,
...
class LiveData<T> extends camerax.LiveData {
  ...
  @override
  Future<void> observe(covariant Observer<T> observer) => super.observe(observer);

  @override
  Future<T?> getValue() async => (await super.getValue()) as T?;

  @override
  // ignore: non_constant_identifier_names
  LiveData<T> pigeon_copy() => LiveData<T>.detached(
      type: type,
      pigeon_binaryMessenger: pigeon_binaryMessenger,
    );
}
...
class Observer<T> extends camerax.Observer {
  ...
  @override
  // ignore: non_constant_identifier_names
  Observer<T> pigeon_copy() => Observer<T>.detached(
