...
import 'camera_preview.dart' show CameraPreview;
...
Future<List<CameraDescription>> availableCameras() async => CameraPlatform.instance.availableCameras();
...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  Future<void> _initializeWithDescription(CameraDescription description) async {
    ...
    try {
      ...
      unawaited(
        CameraPlatform.instance.onCameraInitialized(_cameraId).first.then(initializeCompleter.complete),
      );
