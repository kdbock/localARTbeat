...
class _CameraExampleHomeState extends State<CameraExampleHome>
  ...
  Widget _modeControlRowWidget() => Column(
      children: <Widget>[
        Row(
  ...
  Widget _flashModeControlRowWidget() => SizeTransition(
...
class CameraApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const MaterialApp(home: CameraExampleHome());
}
