...
class MiniController extends ValueNotifier<VideoPlayerValue> {
    ...
    void eventListener(VideoEvent event) {
      switch (event.eventType) {
        case VideoEventType.initialized:
          ...
          _platform.setVolume(_playerId, 1);
  ...
  Future<Duration?> get position async => _platform.getPosition(_playerId);
...
class _VideoPlayerState extends State<VideoPlayer> {
  ...
  @override
  Widget build(BuildContext context) => _playerId == MiniController.kUninitializedPlayerId
        ? Container()
