...
String getUrlForAssetAsNetworkSource(String assetKey) => 'https://github.com/flutter/packages/blob/'
...
Future<Duration> _getDuration(AndroidVideoPlayer player, int playerId) => player
