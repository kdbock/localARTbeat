...
VideoPlayerInstanceApi _productionApiProvider(int playerId) => VideoPlayerInstanceApi(messageChannelSuffix: playerId.toString());
...
) => pigeon.videoEvents(instanceName: streamIdentifier);
...
class AndroidVideoPlayer extends VideoPlayerPlatform {
  ...
  void ensurePlayerInitialized(int playerId, VideoPlayerViewState viewState) {
    _players.putIfAbsent(playerId, () => _PlayerInstance(
  ...
  @override
  Future<void> setLooping(int playerId, bool looping) => _playerWith(id: playerId).setLooping(looping);

  @override
  Future<void> play(int playerId) => _playerWith(id: playerId).play();

  @override
  Future<void> pause(int playerId) => _playerWith(id: playerId).pause();

  @override
  Future<void> setVolume(int playerId, double volume) => _playerWith(id: playerId).setVolume(volume);
  ...
  @override
  Future<void> seekTo(int playerId, Duration position) => _playerWith(id: playerId).seekTo(position);

  @override
  Future<Duration> getPosition(int playerId) async => _playerWith(id: playerId).getPosition();

  @override
  Stream<VideoEvent> videoEventsFor(int playerId) => _playerWith(id: playerId).videoEvents();

  @override
  Widget buildView(int playerId) => buildViewWithOptions(VideoViewOptions(playerId: playerId));
  ...
  @override
  Future<void> setMixWithOthers(bool mixWithOthers) => _api.setMixWithOthers(mixWithOthers);
  ...
  @override
  Future<void> selectAudioTrack(int playerId, String trackId) => _playerWith(id: playerId).selectAudioTrack(trackId);
...
class _PlayerInstance {
  ...
  Future<void> seekTo(Duration position) => _api.seekTo(position.inMilliseconds);

  Future<Duration> getPosition() async => Duration(milliseconds: await _api.getCurrentPosition());

  Stream<VideoEvent> videoEvents() => _eventStreamController.stream;
  ...
  List<DurationRange> _bufferRangeForPosition(int milliseconds) => <DurationRange>[
