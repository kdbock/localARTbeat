            ...
            child: ListView(
              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      SponsorshipCtaTile(
                        ...
                        title: 'Title Sponsor',
                        subtitle:
                            'Be the face of Local ARTbeat',
                        onTap: () =>
                            _go(context, '/title-sponsorship'),
                      ),
                    ],
                  ),
                ),
                SponsorshipSection(
                  title: 'Experiences',
                  subtitle:
                      'Engage users through art and exploration',
                  child: Column(
                    children: [
                      SponsorshipCtaTile(
                        icon: Icons.map,
                        ...
                        subtitle:
                            'Create a walk featuring your business',
                        onTap: () =>
                            _go(context, '/art-walk-sponsorship'),
                      ),
                      ...
                      SponsorshipCtaTile(
                        ...
                        subtitle:
                            'Sponsor a Local ARTbeat tour',
                        onTap: () =>
                            _go(context, '/event-sponsorship'),
                      ),
                    ],
                  ),
                ),
                SponsorshipSection(
                  title: 'Discovery',
                  subtitle:
                      'Appear when users explore nearby art',
                  child: Column(
                    children: [
                      SponsorshipCtaTile(
                        ...
                        subtitle:
                            'Sponsor nearby art captures',
                        onTap: () =>
                            _go(context, '/capture-sponsorship'),
                      ),
                      const SizedBox(height: 12),
                      SponsorshipCtaTile(
                        icon: Icons.radar,
                        ...
                        subtitle:
                            'Sponsor instant discoveries',
                        onTap: () =>
                            _go(context, '/discover-sponsorship'),
                      ),
                    ],
                  ),
                ),
