...
violations=()
pattern='FirebaseAuth\.instance|FirebaseFirestore\.instance|ProfileAnalyticsService\(|ProfileActivityService\(|ProfileAchievementReadService\(|ProfileRewardsService\(|ProfileChallengeService\(|AchievementService\(|UserService\('
